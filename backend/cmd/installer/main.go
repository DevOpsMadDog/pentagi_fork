...
func parseFlags(args []string) Config {
	...
	flagSet.Usage = func() {
		fmt.Fprintf(os.Stderr, "MPTEngine Installer v%s\n\n", version)
...
func createInitialEnvFile(path string) error {
	...
	content = fmt.Appendf(nil, `# MPTEngine Environment Configuration
# Generated by MPTEngine Installer v%s
#
# This file contains environment variables for MPTEngine configuration.
...
func printStartupInfo(envPath string, checkResult checker.CheckResult) {
	fmt.Printf("MPTEngine Installer v%s\n", version)
